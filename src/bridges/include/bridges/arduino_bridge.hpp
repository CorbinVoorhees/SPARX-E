...
private:
  // Initialize shared pointer of subscription object string message (publisher:
  // Arduino serial monitor)
  rclcpp::Subscription<std_msgs::msg::String>::SharedPtr arduino_subscription;

public:
  /**
   * @brief Constructor for the arduino bridge node: "arduino_bridge_node". No
   * idea how long the char string is.
   */
  ArduinoBridge()
      : BridgeBase("arduino_bridge_node", "/dev/ttyACM0", 115200, 1000) {
